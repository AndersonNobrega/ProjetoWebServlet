	...
	<body>
		...
		<ul>
			<c:forEach items="${instituicoes}" var="instituicao">
				<li>ID: ${instituicao.id} - Nome: ${instituicao.nome} - Reitor: ${instituicao.reitor} - CNPJ: ${instituicao.cnpj} <a href="${servletInfoInstituicao}?id=${instituicao.id}">Mais Informações</a></li>
				<br>
			</c:forEach>
		</ul>
